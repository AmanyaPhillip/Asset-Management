// =====================================================
// Client Component - Bookings Display (NEW FILE)
// File: src/components/bookings/BookingsClient.tsx
// =====================================================
...
import { Calendar, MapPin, Car, Building2, FileText } from 'lucide-react'
...
export default function BookingsClient({
  ...
  const [bookings] = useState<BookingWithDetails[]>(initialBookings)
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Logged in as: {user.full_name || user.phone_number}
        </p>
      </div>
